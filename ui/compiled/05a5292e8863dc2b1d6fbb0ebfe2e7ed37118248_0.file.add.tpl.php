<?php
/* Smarty version 4.5.3, created on 2025-07-17 19:25:48
  from '/var/www/html/alpha/ui/ui/admin/hotspot/add.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.3',
  'unifunc' => 'content_6879240c802221_39468630',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '05a5292e8863dc2b1d6fbb0ebfe2e7ed37118248' => 
    array (
      0 => '/var/www/html/alpha/ui/ui/admin/hotspot/add.tpl',
      1 => 1742413432,
      2 => 'file',
    ),
  ),
...
function content_6879240c802221_39468630 (Smarty_Internal_Template $_smarty_tpl) {
...
">?</a>
                    ...
                    <div class="form-group">
                        <label class="col-md-2 control-label"><?php echo Lang::T('Package Type');?>
                            ...
                            <a tabindex="0" class="btn btn-link btn-xs" role="button" data-toggle="popover"
                                data-trigger="focus" data-container="body"
                                data-content="<?php echo Lang::T("Personal Plan will only show to personal Customer, Business package will only show to Business Customer");?>
">?</a>
                        </label>
                        <div class="col-md-10">
...
">?</a>
                            ...
                            <div class="col-md-6">
                                <label class="radio-inline">
                                    ...
                                    <?php echo Lang::T('Radius Package');?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                    ...
                    <div class="form-group">
                        <label class="col-md-2 control-label"><a
                                href="<?php echo Text::url('bandwidth/add');?>
 ...
 % <?php echo Lang::T('Tax Rates
                    ...
                    <div class="form-group">
                        <label class="col-md-2 control-label"><?php echo Lang::T('Shared Users');?>
                            ...
                            <a tabindex="0" class="btn btn-link btn-xs" role="button" data-toggle="popover"
                                data-trigger="focus" data-container="body"
                                data-content="<?php echo Lang::T("How many devices can online in one Customer account");?>
">?</a>
                        </label>
                        <div class="col-md-6">
...
">?</a>
                    ...
                    <span id="routerChoose" class="">
                        <div class="form-group">
                            <label class="col-md-2 control-label"><a
                                    href="<?php echo Text::url('routers/add');?>
"><?php echo Lang::T('Router Name');?>
</a></label>
                            <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-2 col-md-10">
                            <button class="btn btn-success"
                                onclick="return ask(this, '<?php echo Lang::T("Continue the Hotspot Package creation process?");?>
')"
                                type="submit"><?php echo Lang::T('Save Changes');?>
</button>
                            Or <a href="<?php echo Text::url('services/hotspot');?>
