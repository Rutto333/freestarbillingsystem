<?php
/* Smarty version 4.5.3, created on 2025-09-25 09:38:36
  from '/var/www/html/demo/ui/ui/admin/header.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.3',
  'unifunc' => 'content_68d4e36cbea2c9_39647947',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'd89567fa1a81b4baee392a0592b240af0d77e1ee' => 
    array (
      0 => '/var/www/html/demo/ui/ui/admin/header.tpl',
      1 => 1758782302,
      2 => 'file',
    ),
  ),
...
function content_68d4e36cbea2c9_39647947 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html>
                ...
                <?php if (in_array($_smarty_tpl->tpl_vars['_admin']->value['user_type'],array('SuperAdmin','Admin','Agent'))) {?>
                    <div class="sidebar-user custom-dropdown" style="margin-top: auto; padding: 10px; border-top: 1px solid #1e40af; background: #1e40af;">
                        <div class="dropdown-toggle" id="userDropdownToggle" style="display: flex; align-items: center; gap: 8px; text-decoration: none; color: #333; cursor: pointer;">
                            ...
                            <span class="hidden-xs" style="font-size: 14px; font-weight: 500; color: #000000;"><?php echo $_smarty_tpl->tpl_vars['_admin']->value['fullname'];?>
</span>
                            <i class="ion ion-chevron-up dropdown-arrow" style="margin-left: auto; font-size: 12px; color: #666; transition: transform 0.3s ease;"></i>
                        </div>
                        ...
                        <div class="custom-dropdown-menu" style="background: #fff; border: 1px solid #e5e5e5; border-radius: 6px; overflow: hidden;">
                            <div class="user-header text-center" style="background: #f5f5f5; padding: 15px; border-bottom: 1px solid #e5e5e5; text-align: center;">
                                ...
                                <p style="margin: 0; font-weight: 600; color: #000000;"><?php echo $_smarty_tpl->tpl_vars['_admin']->value['fullname'];?>
</p>
                                <small style="color: #666;"><?php echo Lang::T($_smarty_tpl->tpl_vars['_admin']->value['user_type']);?>
</small>
                            </div>
...
" style="display: block; padding: 6px; color: #555; text-decoration: none; font-size: 13px;">
...
" class="btn btn-danger btn-sm" style="background: #DC2626; color: #fff; padding: 6px 14px; border-radius: 20px; text-decoration: none; font-size: 13px; display: inline-flex; align-items: center; gap: 5px;">
