<?php
/* Smarty version 4.5.3, created on 2025-08-29 08:50:54
  from '/var/www/html/example/ui/ui/admin/customers/online_users_admin.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.3',
  'unifunc' => 'content_68b13fbec3da70_39727315',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'ed14d779e3789a2151dc483df63f1b62020875d8' => 
    array (
      0 => '/var/www/html/example/ui/ui/admin/customers/online_users_admin.tpl',
      1 => 1756446641,
      2 => 'file',
    ),
  ),
...
function content_68b13fbec3da70_39727315 (Smarty_Internal_Template $_smarty_tpl) {
...
" <?php if ($_smarty_tpl->tpl_vars['r']->value['id'] == $_smarty_tpl->tpl_vars['router_id']->value) {?>selected<?php }?>>
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <i class="fa fa-users"></i> PPPoE Users Online
                </h3>
            </div>
            <div class="panel-body text-center">
                <h2 class="text-success" id="pppoeUsersCount">
                    <i class="fa fa-spinner fa-spin"></i>
                </h2>
                <p>Active PPPoE connections</p>
            </div>
        </div>
    </div>
    <div class="col-md-4">
        <div class="panel panel-warning">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <i class="fa fa-wifi"></i> Hotspot Users Online
                </h3>
            </div>
            <div class="panel-body text-center">
                <h2 class="text-warning" id="hotspotUsersCount">
                    <i class="fa fa-spinner fa-spin"></i>
                </h2>
                <p>Active Hotspot connections</p>
            </div>
        </div>
    </div>
    <div class="col-md-4">
        <div class="panel panel-info">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <i class="fa fa-globe"></i> Total Online Users
                </h3>
            </div>
            <div class="panel-body text-center">
                <h2 class="text-info" id="totalUsersCount">
                    <i class="fa fa-spinner fa-spin"></i>
                </h2>
                <p>All active connections</p>
            </div>
        </div>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="panel panel-success">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <i class="fa fa-ethernet"></i> PPPoE Active Users
    ...
    <div class="col-md-6">
        <div class="panel panel-warning">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <i class="fa fa-wifi"></i> Hotspot Active Users
                    <span class="pull-right">
...
mikrotik-monitor/disconnect" method="POST">
                <div class="modal-body">
                    <p>Are you sure you want to disconnect user <strong id="disconnectUsername"></strong>?</p>
                    <input type="hidden" name="router_id" id="disconnectRouterId" value="<?php echo $_smarty_tpl->tpl_vars['router_id']->value;?>
">
...
function changeRouter(routerId) {
    if (routerId) {
        window.location.href = '<?php echo $_smarty_tpl->tpl_vars['appUrl']->value;?>
/?_route=mikrotik-monitor/' + routerId;
    }
}
...
function loadOnlineUsers() {
    ...
    jQuery.ajax({
        url: '<?php echo $_smarty_tpl->tpl_vars['appUrl']->value;?>
/?_route=mikrotik-monitor/api/online-users/<?php echo $_smarty_tpl->tpl_vars['router_id']->value;?>
',
        method: 'GET',
        dataType: 'json',
        timeout: 10000,
...
function updateOnlineUsersCount(data) {
    const pppoeCount = data.pppoe ? data.pppoe.length : 0;
    const hotspotCount = data.hotspot ? data.hotspot.length : 0;
    const totalCount = data.total || (pppoeCount + hotspotCount);
