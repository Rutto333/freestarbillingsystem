<?php
/* Smarty version 4.5.3, created on 2025-09-12 11:36:38
  from '/var/www/html/myapp/ui/ui/customer/header.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.3',
  'unifunc' => 'content_68c3db969f0bf7_17243675',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'eac760979afd88219834148819cc79b671381b15' => 
    array (
      0 => '/var/www/html/myapp/ui/ui/customer/header.tpl',
      1 => 1757666184,
      2 => 'file',
    ),
  ),
...
function content_68c3db969f0bf7_17243675 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"  style="text-align: center; display: flex; flex-direction: column; align-items: center;"">

                                <div class="user-initials user-image">
                                    <?php echo mb_strtoupper((string) substr($_smarty_tpl->tpl_vars['_user']->value['fullname'],0,2) ?? '', 'UTF-8');?>
                            ...
                            <ul class="dropdown-menu">
                                <li class="user-header">
                                    <div class="user-initials img-circle">
                                        <?php echo mb_strtoupper((string) substr($_smarty_tpl->tpl_vars['_user']->value['fullname'],0,2) ?? '', 'UTF-8');?>
