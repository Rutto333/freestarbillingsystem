...
function initiateRechargeTokens()
{
  ...
  $CallBackURL = U . 'callback/mtokens';
  ...
  $mpesa_consumer_key = "F9whD1He9L7V2PxsZpGKmSoChcBAfBSQfXCMYT52xSpa5QWl";


  $mpesa_consumer_secret = "u2Tr9GBlVIIOMHnG8aN8TXn7scoA1AU8KAHrRzucTqsAkizLecfGNRiVUa9ymz69";


  $mpesa_business_code = "4164679";
  ...
  $mpesa_pass_key = "ee3965abccf07decb8a9764b8e2351a86c2ccc79714668cbe3b893609da54fc3";
  ...
  $curl2_post_data = array(
    ...
    'AccountReference' => 'messsageTokens',
...
if ($responseCode == "0") {
    ...
    echo json_encode([
        "success" => false,
        "message" => "There is an issue with the transaction, please try again"
    ]);
}
