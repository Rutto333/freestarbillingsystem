...
switch ($do) {
        ...
        if ($username != '' and $password != '') {
            ...
            if ($d) {
                ...
                if (Password::_verify($password, $d_pass) == true) {
                    ...
                    $_SESSION['login_error'] = Lang::T('Invalid username or password. Please try again.');
                    r2(getUrl('admin'));
                }
            } else {
                // User not found - log the attempt
                _log($username . ' ' . Lang::T('Failed Login'), 'unknown');
            ...
            $_SESSION['login_error'] = Lang::T('Please enter both username and password.');
            r2(getUrl('admin'));
        }
        break;
    ...
    default:
        ...
        // Pass any error message to the template
        if (isset($_SESSION['login_error'])) {
            $ui->assign('error_message', $_SESSION['login_error']);
